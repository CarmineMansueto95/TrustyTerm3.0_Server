...
#define TT_AES_KEY_SIZE 32		// 256 bits key
#define TT_AES_KEY_STR_LEN 64	// 256 bits -> hex string of length 64
#define TT_AES_IV_SIZE 12		// 96 bits IV
#define TT_AES_IV_STR_LEN 24
#define TT_AES_TAG_SIZE 16		// 128 bits TAG
#define TT_AES_TAG_STR_LEN 32
...
/* ====================== CUSTOM CODE ====================== */
void print_kex_data(struct ssh *ssh);
...
void set_ssh2tt_session_fifo_path(struct ssh *ssh, char *ssh2tt_session_path);
void set_tt2ssh_session_fifo_path(struct ssh *ssh, char *tt2ssh_session_path);
